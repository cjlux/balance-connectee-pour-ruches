...
class BalRucheData(models.Model):
  ...
  w_num = models.IntegerField('N° semaine', default=0, db_index=True)
  d_num = models.IntegerField('N° jour', default=0, db_index=True)
  humid = models.IntegerField('humidité (%)', default=0)
  temp  = models.IntegerField('température (°C)', default=0)
  m1 = models.FloatField("Masse ruche-1", default=0)
  m2 = models.FloatField("Masse ruche-2", default=0)
  m3 = models.FloatField("Masse ruche-3", default=0)
  m4 = models.FloatField("Masse ruche-4", default=0)
  ...
  def info(self):
    ...
    mess += f"\tmasse_ruche1={self.m1:.2f}\n\tmasse_ruche2={self.m2:.2f}\n"
    mess += f"\tmasse_ruche3={self.m3:.2f}\n\tmasse_ruche4={self.m4:.2f}\n"
    return mess
